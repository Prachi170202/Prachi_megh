    ...
    app.config([
        ...
        function ($stateProvider, $urlRouterProvider, $locationProvider, $qProvider) {
            ...
            $stateProvider
                ...
                .state('person', {
                    url: '/person',
                    templateUrl: '/App/Main/views/person/index.cshtml',
                    menu: 'Person' //Matches to name of 'About' menu in TestDemoNavigationProvider
                })
                .state('depart', {
                    url: '/depart',
                    templateUrl: '/App/Main/views/depart/index.cshtml',
                    menu: 'DepartmentApplication' //Matches to name of 'About' menu in TestDemoNavigationProvider
                })
                .state('carr', {
                    url: '/carr',
                    templateUrl: '/App/Main/views/carr/index.cshtml',
                    menu: 'Car' //Matches to name of 'Car' menu in TestDemoNavigationProvider
                });
        }
    ]);
